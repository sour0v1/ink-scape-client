        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <ul className='space-y-2'>
                        <li>Address: 123 Artisan Street, Craftville, CA 12345, USA</li>
                        <li>Phone: +1 (555) 123-4567</li>
                        <li>Email: info@craftyartstore.com</li>
                        <li>Hours of Operation: Monday - Saturday: 9:00 am - 6:00 pm (Closed on Sundays)</li>
                    </ul>
                </nav>
                <nav>
                    <h6 className="footer-title">Quik Link</h6>
                    <a><NavLink to={'/'}>Home</NavLink></a>
                    <a><NavLink to={'all-art-craft'}>All Art & Crafts</NavLink></a>
                    <a><NavLink to={'add-art-craft'}>Add Craft item</NavLink></a>
                    <a><NavLink to={'my-art-craft'}>My art and craft list</NavLink></a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>inkScape. <br />Explore endless creativity with Inkscape.</p>
                </aside>
