...
const Registration = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto flex flex-col-reverse md:flex-row justify-center md:justify-start items-center gap-9 w-full md:h-[550px] bg-gray-50 rounded-tl-btn rounded-bl-btn">          
            ...
            <div className="w-full md:w-1/2 md:mr-9 px-4 md:px-0 space-y-6">
                ...
                <form onSubmit={handleRegistration} className="space-y-3 w-full">                  
                        ...
                        <input className="border-b-2 border-black w-full bg-gray-50 outline-none py-2" placeholder="Email" type="email" name="email" id="name" required/>
                        <input className="border-b-2 border-black w-full bg-gray-50 outline-none py-2" placeholder="Password" type="text" name="password" id="name" required/>
                        <input className="border-b-2 border-black w-full bg-gray-50 outline-none py-2" placeholder="Photo URL" type="text" name="link" id="name"/>
